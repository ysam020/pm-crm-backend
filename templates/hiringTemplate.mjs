export const hiringTemplate = (name, joining_date) => {
  return `
                                  ...
                                  <tr>
                                    ...
                                    >
                                      ...
                                      <p
                                        ...
                                        "
                                      >
                                        We are thrilled to have you as part of our team and look forward to the contributions you will make.
                                        <br />
                                        <br />
                                        ...
                                        Best regards,
                                        <br />
                                        Paymaster Management Solutions Limited
                                        <br />
                                        HR Team
                                      </p>
                                      <p
